...
$(document).ready(function () {
    ...
    $('#position-top-end').on('click', function () {
      Swal.fire({
        position: 'top-end',
        type: 'success',
        title: 'Seu cliente foi cadastrado',
        showConfirmButton: false,
        timer: 1500,
        confirmButtonClass: 'btn btn-primary',
        buttonsStyling: false,
    ...
    $('#type-success').on('click', function () {
      Swal.fire({
        title: "Tem certeza ?!",
        text: "Você esta excluindo um cliente!",
        type: "success",
        timer: 10000,  
        confirmButtonClass: 'btn btn-primary',
        buttonsStyling: false,
    ...
    $('#type-info').on('click', function () {
      Swal.fire({
        title: "Dívida criada!",
        text: "A dívida deste cliente foi criada!",
        type: "info",
        confirmButtonClass: 'btn btn-primary',
        buttonsStyling: false,
      });
    ...
    $('#type-error').on('click', function () {
      Swal.fire({
        title: "Dívida paga!",
        text: " Esta dívida esta sendo excluida!",
        type: "error",
        confirmButtonClass: 'btn btn-primary',
        buttonsStyling: false,
      });
